...
class QuickDiagnostic extends StatefulWidget {
  const QuickDiagnostic({super.key});

  @override
  State<QuickDiagnostic> createState() => _QuickDiagnosticState();
}
...
class _QuickDiagnosticState extends State<QuickDiagnostic>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          isenglish ? "QuickDiagnostic" : "الفحص السريع",
              ...
              builder: (context, state) {
                return Column(
                  children: [
                    ...
                    Lottie.asset(AppLotti.person, height: 200),
                    Row(
