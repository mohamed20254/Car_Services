...
class WinchRequest extends StatefulWidget {
  const WinchRequest({super.key});

  @override
  State<WinchRequest> createState() => _WinchRequestState();
}

class _WinchRequestState extends State<WinchRequest>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          isenglish ? "winch request" : "طلب الونش",
